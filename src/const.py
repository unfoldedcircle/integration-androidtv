from ucapi.ui import DeviceButtonMapping, Buttons, EntityCommand, UiPage
...
REMOTE_BUTTONS_MAPPING: list[DeviceButtonMapping] = [
    ...
    DeviceButtonMapping(button="STOP", short_press=EntityCommand(**{"cmd_id": Commands.STOP})),  # TODO missing R3 buttons in UCAPI
    DeviceButtonMapping(button="MENU", short_press=EntityCommand(**{"cmd_id": Commands.CONTEXT_MENU})),  # TODO missing R3 buttons in UCAPI
]
